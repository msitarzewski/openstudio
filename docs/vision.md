...
#    - Safari has WebAudio quirks (see docs/SAFARI_WEBAUIO_QUIRKS.md)
...
- Program bus to Icecast (OGG/Opus)
...
- **[Architecture Docs](./ARCHITECTURE-IMPLEMENTATION.md)**: System design and data flow
